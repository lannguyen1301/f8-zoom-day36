...
<Div class="hero">
    <Div class="hero-text">
      ...
      <Para>
        ...
        With years of experience across various industries, our dedicated team is committed to driving growth 
        and operational excellence.
      </Para>
      <Div class="hero-buttons">
        <Link href="#" class="btn-primary">Get Started →</Link>
        <Link href="#" class="btn-outline">Free trial</Link>
      </Div>
      ...
      <Div class="stats">
        ...
        <Div class="stat">
          ...
          <Para>Highly efficient financial strategies</Para>
        </Div>
      </Div>
    </Div>

    <Div class="hero-image">
      <Img src="https://images.unsplash.com/photo-1580489942398-784ebe1d0bb1?w=600" alt="Professional woman">
    </Div>
  </Div>
</Div>
