        ...
        <>
            <Section className="container">
                <Div className={styles.privacy}>
                    ...
                    <div class={styles.}policy-list">
                        <div class={styles.policy-card}>
                            <div class={styles.card-header}>
                                <div class={styles.}card-icon">
                                    <i class={styles.}fas fa-shield-alt"></i>
                                </div>
                        ...
                        <div class={styles.}policy-card">
                            <div class={styles.card-header}>
                                <div class={styles.}card-icon">
                                    <i class={styles.}fas fa-cookie-bite"></i>
                                </div>
                                <h3 class={styles.}card-title">
                        ...
                        <div class={styles.}policy-card">
                            <div class={styles.card-header}>
                                <div class={styles.}card-icon">
                                    <i class={styles.}fas fa-user-shield"></i>
                                </div>
                                <h3 class={styles.}card-title">5. Quyền của bạn</h3>
                            </div>
                            <div class={styles.}card-content">
                                <p>Bạn có quyền:</p>
                        ...
                        <div class={styles.}policy-card">
                            <div class={styles.card-header}>
                                <div class={styles.}card-icon">
                                    <i class={styles.}fas fa-envelope"></i>
                                </div>
                                <h3 class={styles.}card-title">6. Liên hệ</h3>
                            </div>
                            <div class={styles.}card-content">
                                <p>
