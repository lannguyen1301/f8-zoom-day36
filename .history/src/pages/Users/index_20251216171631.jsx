                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/figma.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/zapier.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/notion.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/slack.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/zendesk.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/jira.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/dropbox.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/google-chrome.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/discord.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
                        ...
                        <Div className={styles.cardHeader}>
                            <Div className={styles.cardHeaderInner}>
                                <Span>
                                    <Img
                                        className={styles.cardHeaderImg}
                                        src="https://assets.codepen.io/285131/google-drive.svg"
                                    />
                                </Span>
                                <SubsectionTitle
                                    className={styles.cardHeaderTitle}
