            ...
            <Section className="container">
                ...
                <Div className={styles.hero}>
                    <Div className={styles.heroText}>
                        ...
                        <Div className={styles.stats}>
                            <Div className={styles.stat}>
                                <SubsectionTitle className={styles.statTitle}>
                                    95%
                                </SubsectionTitle>
                                <Para className={styles.statDesc}>
                    ...
                    <Div className={styles.heroImage}>
                        <Img
                            className={styles.heroImageItem}
                ...
                <Div className={styles.benefits}>
                    <Div className={styles.container}>
                        <Div className={styles.benefitsImage}>
                            <Img
                                className={styles.benefitsImageItem}
                        ...
                        <Div>
                            <SubTitle className={styles.benefitsTitle}>
                                Unlock our expertise to drive success across
                                industries.
                            </SubTitle>
                            <Para className={styles.benefitsDesc}>
                ...
                <Div className={styles.milestones}>
                    <SubTitle className={styles.milestonesTitle}>
                        Our journey: key milestones and achievements
                    </SubTitle>
                    <Para className={styles.milestonesDesc}>
