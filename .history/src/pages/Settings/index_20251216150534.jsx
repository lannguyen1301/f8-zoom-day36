        ...
        <>
            ...
            <Div class="cardGrid">
              ...
              <Article class="card">
                ...
                <Div class="card-body">
                  <Para>Build custom automations and integrations with apps.</p>
                </Div>
                <Div class="cardFooter">
                  <Link href="#">View integration</Link>
                </Div>
              ...
              <Article class="card">
                ...
                <Div class="card-body">
                  <Para>Send notifications to channels and create projects.</p>
                </Div>
                <Div class="cardFooter">
                  <Link href="#">View integration</Link>
                </Div>
              ...
              <Article class="card">
                ...
                <Div class="card-body">
                  <Para>Plan, track, and release great software.</Para>
                </Div>
                <Div class="cardFooter">
                  <Link href="#">View integration</Link>
                </Div>
              ...
              <Article class="card">
                ...
                <Div class="card-body">
                  <Para>Everything you need for work, all in one place.</p>
                </Div>
                <Div class="cardFooter">
                  <Link href="#">View integration</Link>
                </Div>
              ...
              <Article class="card">
                <Div class="cardHeader">
                  <Div>
                    <Span>
                    <Img src="https://assets.codepen.io/285131/discord.svg"></Span>
              ...
              <Article class="card">
                <Div class="cardHeader">
                  <Div>
                    <Span>
                    <Img src="https://assets.codepen.io/285131/google-drive.svg"></Span>
