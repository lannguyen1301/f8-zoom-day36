...
<Img className={clsx(styles.heroImg, styles.heroImgSmall)}></Img>
                                </Div>
                        </Div>
                    </Div>
                </Div>
                        ...
                        <a href="#!" class="btn btn--primary hero__cta-btn">
                            ...
                            <span class="btn__icon">
                                <svg width="9" height="8" viewBox="0 0 9 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.48584 1.5L5.98584 4L3.48584 6.5" stroke="#FD5056" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </span>
                        </a>
