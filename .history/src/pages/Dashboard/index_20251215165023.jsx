            ...
            <Div className={styles.appBodyMainContent}>
                <Section className={styles.serviceSection}>
                    ...
                    <Div className={styles.serviceSectionHeader}>
                        ...
                        <Button className={styles.flatButton}>Search</Button>
                    </Div>
                ...
                <Section className={styles.transferSection}>
                    <Div className={styles.transferSectionHeader}>
                        ...
                        <Div className={styles.filterOptions}>
                            <Para>Filter selected: more than 100 $</Para>
                    ...
                    <Div className={styles.transfers}>
                        <Div className={styles.transfer}>
                            ...
                            <Div className={styles.transferNumber}>- $ 550</Div>
                        </Div>
                        <Div className={styles.transfer}>
                            <Div className={styles.transferLogo}>
                            ...
                            <Div className={styles.transferNumber}>- $ 120</Div>
                        </Div>
                        <Div className={styles.transfer}>
                            <Div className={styles.transferLogo}>
                            ...
                            <Div className={styles.transferNumber}>- $ 70</Div>
                        </Div>
                    </Div>
                </Section>
            </Div>
                    ...
                    <Div className={styles.payments}>
                        <Div className={styles.payment}>
                            ...
                            <Div className={styles.paymentDetails}>
                                <SubsectionTitle>Internet</SubsectionTitle>
                                <Div>
                                    <Span>$ 2,110</Span>
                                    <Button className={styles.iconButton}>
                                        <i className="fa-solid fa-angle-right"></i>
                        ...
                        <Div className={styles.payment}>
                            <Div className={clsx(styles.card, styles.olive)}>
                                <Span>12/23</Span>
                                <Span>•••• 2228</Span>
                            </Div>
                            <Div className={styles.paymentDetails}>
                                <SubsectionTitle>Universal</SubsectionTitle>
                                <Div>
                                    <Span>$ 5,621</Span>
                                    <Button className={styles.iconButton}>
                                        <i className="fa-solid fa-angle-right"></i>
                        ...
                        <Div className={styles.payment}>
                            <Div className={clsx(styles.card, styles.gray)}>
                                <Span>03/22</Span>
                                <Span>•••• 5214</Span>
                            </Div>
                            <Div className={styles.paymentDetails}>
                                <SubsectionTitle>Gold</SubsectionTitle>
                                <Div>
                                    <Span>$ 3,473</Span>
                                    <Button className={styles.iconButton}>
                                        <i className="fa-solid fa-angle-right"></i>
