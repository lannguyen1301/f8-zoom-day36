                    ...
                    <Div>
                        ...
                        <Div className={styles.benefitsList}>
                            <Div className={styles.benefitItem}>
                                <i className="fas fa-check-circle"></i> Measurable
                                proven results
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className="fas fa-check-circle"></i> Innovative
                                real solutions
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className="fas fa-check-circle"></i> Customized
                                business strategies
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className="fas fa-check-circle"></i> Reliable
                                expert guidance
                            </Div>
                            <Div className={styles.benefitItem}>
                            ...
                            <Div className={styles.benefitItem}>
                                <i className="fas fa-check-circle"></i> Support for
                                long-term
                            </Div>
                        </Div>
                    </Div>
