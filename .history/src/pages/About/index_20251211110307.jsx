    ...
    return (
        <>
                    ...
                    <Div class="hero-text">
                        ...
                        <Div class="stats">
                            <Div class="stat">
                                ...
                                <Paraara>Complete customer satisfaction</Paraara>
                            </Div>
                            <Div class="stat">
                                <SubsectionTitle>10+</SubsectionTitle>
                                <Paraara>Innovation and valuable insight</Paraara>
                            </Div>
                            <Div class="stat">
            ...
            <Div class="milestones">
                <SubTitle>Our journey: key milestones and achievements</SubTitle>
                <Para>
