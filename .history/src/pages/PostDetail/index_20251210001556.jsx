...
// useNavigate: Ý nghĩa: hook để theo dõi trạng thái điều hướng trong React Router. Nhiệm vụ: cung cấp thông tin về quá trình chuyển trang hoặc gửi form. Chức năng: giúp bạn hiển thị loading spinner, disable nút, hoặc tạo UI “optimistic” khi dữ liệu đang thay đổi.
