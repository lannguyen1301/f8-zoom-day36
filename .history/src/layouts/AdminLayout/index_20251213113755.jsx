		...
		<div className={styles.appBodySidebar}>
			<section className={styles.paymentSection}>
				...
				<div className={styles.paymentSectionHeader}>
					...
					<div>
						<button className={clsx(styles.cardButton, styles.mastercard)}>
						...
						<button className={clsx(styles.cardButton, styles.visa, styles.active)}>
				...
				<div className={styles.paymentSection-footer}>
