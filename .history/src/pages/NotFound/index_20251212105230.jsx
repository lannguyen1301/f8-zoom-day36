        ...
        <Div className={styles.container}>
            ...
            <Div className={styles.scene}>
                ...
                <Div className={styles.dog}>
                    ...
                    <Div className={clsx(styles.paw, styles.front, styles.left)}></Div>
                    <Div className={styles.}paw front right"></Div>
                    <Div className={styles.}paw back left"></Div>
                    <Div className={styles.}paw back right"></Div>
