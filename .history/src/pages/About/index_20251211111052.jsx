                    ...
                    <Div>
                        ...
                        <Div className={styles.benefitsList"\}>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i> Measurable
                                proven results
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i> Innovative
                                real solutions
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i> Customized
                                business strategies
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i> Reliable
                                expert guidance
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i>{" "}
                                Multi-industry expertise
                            </Div>
                            <Div className={styles.benefitItem}>
                                <i className={styles.}fas fa-check-circle"></i> Support for
                                long-term
                            </Div>
                        </Div>
                    </Div>
                ...
                <Div className={styles.}cards">
                    <Div className={styles.}card">
                        <Div className={styles.}cardIcon">
                            <i className={styles.}fas fa-laptop-code"></i>
                        </Div>
                        <SubsectionTitle>
                    ...
                    <Div className={styles.}card">
                        <Div className={styles.}cardIcon">
                            <i className={styles.}fas fa-chart-line"></i>
                        </Div>
                    ...
                    <Div className={styles.}card">
                        <Div className={styles.}cardIcon">
                            <i className={styles.}fas fa-coins"></i>
                        </Div>
                        <SubsectionTitle>Financial Consulting</SubsectionTitle>
                        <Para>
                            Expert guidance to optimize your financial
