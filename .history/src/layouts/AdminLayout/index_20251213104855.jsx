            ...
            <Section>
                <Div class="app">
                    <header class="appHeader">
                        <Div class="appHeaderLogo">
                            <Div class="logo">
                                ...
                                <Title class="logoTitle">
                                    <Span>Almeria</Span>
                                    <Span>NeoBank</Span>
                                </Title>
                            </Div>
                        </Div>
                        <Div class="appHeaderNavigation">
                            <Div class="tabs">
                        ...
                        <Div class="appHeaderActions">
                            ...
                            <Div class="appHeaderActionsButtons">
                                <Button class="iconButton large">
                    ...
                    <Div class="appBody">
                        ...
                        <Div class="appBody-main-content">
                            <Section class="service-section">
                                ...
                                <Div class="service-section-header">
                                    ...
                                    <Button class="flatButton">Search</Button>
                                </Div>
